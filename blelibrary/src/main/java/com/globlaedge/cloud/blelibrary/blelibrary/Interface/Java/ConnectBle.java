    ...
    BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_PAIRING_REQUEST.equals(action)) {
                ...
                if (mBluetoothDevice != null) {
                    ...
                    try {
                        ...
                        /*Logger.i(TAG,"pin value : "+pin);
                        Logger.i(TAG,"passkey value : "+passkey);*/
            ...
            if (action.equals(BluetoothDevice.ACTION_BOND_STATE_CHANGED)) {
                ...
                Logger.i(TAG, "state value : "+state);
                if (state < 0) {
                    Toast.makeText(context, "Please try again!", Toast.LENGTH_LONG).show();
                    //we should never get here
                } else if (state == BluetoothDevice.BOND_BONDING) {

                    Logger.i(TAG, "bonding state value : "+BluetoothDevice.BOND_BONDING);
                    ...
                    Logger.d(TAG, "Paired");
                    Logger.i(TAG, "bonded state value : "+BluetoothDevice.BOND_BONDED);
//                    activity.unregisterReceiver(receiver);
                    getService();
                    ...
                    Logger.i(TAG, "bond none state value : "+BluetoothDevice.BOND_NONE);
    ...
    private boolean connectDevice(BluetoothDevice device) {
        ...
        try {
            ...
            serviceDiscoverDialog.createDialog(activity.getString(R.string.pairing));
            isConnected = true;
    ...
    private class BleConnectionTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            serviceDiscoverDialog.createDialog(activity.getString(R.string.connecting));
