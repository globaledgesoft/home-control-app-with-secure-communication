...
//        characteristic.getValue();
    ...
    private void broadcastUpdate(final String action,
        ...
        if(action.equals(ACTION_SMOKE_DATA_AVAILABLE)) {
            ...
            smokeVal = characteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT16
                    ,0);
            ...
            bulbData = characteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT8,
                    0);
