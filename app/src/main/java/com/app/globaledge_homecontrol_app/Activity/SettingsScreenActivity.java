...
import com.app.globaledge_homecontrol_app.Adapter.SettingAdapter;
import com.app.globaledge_homecontrol_app.R;

import java.util.ArrayList;

//SettingsScreenActivity responsible for displaying setting feature app provides
public class SettingsScreenActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    /**
     * onClick on backButton in Settings Screen
     *
     * @param v View
     */
    @Override
